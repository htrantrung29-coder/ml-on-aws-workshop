---
title: "5.9 Tự động hóa Pipeline"
date: 2026-07-31
weight: 9
chapter: false
pre: "<b>5.9 </b>"
...
Do quota SageMaker Pipelines bị giới hạn, chúng ta xây dựng pipeline dạng Python function thay thế. Pipeline này tự động hóa toàn bộ quy trình từ xử lý dữ liệu, huấn luyện đến lưu model.
...
def run_pipeline(input_s3_uri, learning_rate=0.01, max_depth=3, n_estimators=100):
    print("=" * 50)
    print("TITANIC ML PIPELINE BẮT ĐẦU")
    print("=" * 50)
