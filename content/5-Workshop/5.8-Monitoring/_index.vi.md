...
Tạo 2 alarms để theo dõi endpoint:
...
cw_client.put_metric_alarm(
    ...
    AlarmDescription="Cảnh báo khi endpoint có lỗi 5XX",
...
cw_client.put_metric_alarm(
    ...
    AlarmDescription="Cảnh báo khi latency > 1s",
...
print("Monitoring Schedule đã tạo!")
```
